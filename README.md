...
[![GitHub CI](https://img.shields.io/github/workflow/status/Sage-Bionetworks/nlp-sandbox-physical-address-annotator-example/ci.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&logo=github)](https://github.com/nlpsandbox/physical-address-annotator-example/actions)
[![GitHub License](https://img.shields.io/github/license/Sage-Bionetworks/nlp-sandbox-physical-address-annotator-example.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&logo=github)](https://github.com/nlpsandbox/physical-address-annotator-example/blob/develop/LICENSE)
...
Physical Address Annotator]. The Physical Address Annotator is one of the first
NLP Tools that can be benchmarked on [nlpsandbox.io]. A Physical Address
Annotator takes as input a clinical note and outputs a list of predicted
physical address annotations found in the clinical note.
...
The command below starts the Physical Address Annotator locally.
...
The Physical Address Annotator provides a web interface that you can use to
annotate clinical notes. The address of this interface depends on whether you
run the Physical Address Annotator using Docker (production mode) or the Python
development server.
...
This section describes how you can start developing your own Physical Address
...
Address Annotator from
scratch](#Creating-a-new-physical-address-annotator-from-scratch).
...
### Creating a new Physical Address Annotator from scratch

Follow the steps listed below to generate an initial implementation - also
called "stub" - of the Physical Address Annotator using one of the many
languages and framework supported by [OpenAPITools/openapi-generator].

1. Download the latest OpenAPI specification of the [NLP Sandbox Physical
   Address Annotator].
...
Here is the protocol that we apply to update this example Physical Address
Annotator when a new release of the Physical Address Annotator specification is
available:
...
2. Download the latest OpenAPI specification of the Physical Address Annotator.
...
- `Physical Address Annotator API version`: The version of the Physical Address
  Annotator specification implemented by the tool.
